...
**状态**：F1 / F2 / F3 已实施完毕（2026-09-04）。阶段二的机械合并亦已完成，
记录见 [`2026-09-04-upstream-merge-phase2-design.md`](./2026-09-04-upstream-merge-phase2-design.md)；
DNS 收敛（原第七节的 A/B/C 与两套设置并存问题）待执行。**开工前先读那份文档的第六节。**

**核实基准**：
- 本文 1.0 版写于 `4fec2e6`（2026-09-02）；1.1 / 1.2 版更新于 `e83d502` 之后，1.3 版更新于 `08a1700` 之后（均 2026-09-04）
...
**文档版本**：1.3
**最后更新**：2026-09-04
**状态**：F1 / F2 / F3 已实施完毕并通过复核。阶段二的机械合并已完成（`08a1700`，
127 files / 842 tests 全绿），执行记录与后续交接见
[`2026-09-04-upstream-merge-phase2-design.md`](./2026-09-04-upstream-merge-phase2-design.md)。
DNS 收敛待另起会话执行。
